...
function FinishingDetails() {
    const pricePerSquareMeter = 299.0; // Price per square meter
    const areaInSquareFeet = 350; // Area in square feet
    const areaInSquareMeters = areaInSquareFeet * 0.092903; // Convert square feet to square meters
    const totalPrice = (areaInSquareMeters * pricePerSquareMeter).toFixed(2); // Calculate total price
                    ...
                    <li>
                        <div className="property-card">
                            ...
                            <div className="card-content">
                                ...
                                <p className="card-price">${totalPrice}</p> {/* Display total price */}
                                ...
                                <ul className="card-list">
                                    ...
                                    <li className="card-item">
                                        ...
                                        <span>Square Ft</span>
                                        <span> (${pricePerSquareMeter}/m²)</span> {/* Display price per square meter */}
                                    </li>
                                </ul>
