                        ...
                        <li>
                            <div className="property-card">
                                ...
                                <div className="card-content">
                                    ...
                                    <button>
                                        <a href="/finishing" className="btn">
                                            Details
                                        </a>
                                    </button>
                                </div>
                        ...
                        <li>
                            <div className="property-card">
                                ...
                                <div className="card-content">
                                    ...
                                    <h3 className="h3 card-title">
                                        <a href="#">Ceramic Floor Finishing</a>
                                    </h3>
                                    <p className="card-text">
                                        This project involves finishing the
